...
export async function GET(request: NextRequest) {
  try {
    ...
    // Allow access if we have any form of authentication or in development
    const isAuthenticated = authHeader || cookieHeader || process.env.NODE_ENV === 'development';
    ...
    console.error('Error in simplified dashboard overview:', error);
    return NextResponse.json(
      { 
